    ...
    <div className=" bg-neutral-200  dark:bg-neutral-900 ">
      <div className="isolate ">
       ...
       dark:bg-amber-500 rounded-full blur-3xl opacity-20"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16 ">
            <div className="flex-1 space-y-6 lg:space-y-7">
              ...
              max-w-2xl font-light"
                >
                  ...
                  powered by the latest Tailwind V4.Create stunning user
                  exprences with state-of-the-art theme switching.
                </p>
            ...
            <div className="flex-1 w-full">
              <div className="relative ">
                <div
                  className="absolute -inset-0.5 bg-gradient-to-r from-amber-500 
                        to-indigo-900 rounded-2xl blur-xl opacity-50 animate-pulse"
                ></div>
                ...
                bg-neutral-100 dark:bg-neutral-500 overflow-hidden relative"
                  ...
                  <div className="mt-3 lg:mt-4 justify-between items-center flex">
                    <div className="flex gap-2 ">
                      <span
                        className="px-2.5 py-1 lg:px-3 rounded-full bg-neutral-900
                    text-amber-400 text-xs font-medium flex items-center"
                      >
                        <i className="bx bxl-tailwind-css mr-1"></i> Tailwind V4
                      </span>
                      <span
                        className="px-2.5 py-1 lg:px-3 rounded-full bg-neutral-100 dark:bg-neutral-800 
                      text-indigo-900 dark:text-indigo-400 border border-neutral-200
                    text-xs font-medium flex items-center dark:border-neutral-700"
                      >
                        <i className="bx bxl-react mr-1"></i> React
                      </span>
                    </div>
                    <button
                      className="w-8 h-8 lg:w-9 lg:h-9 xl:w-10 xl:h-10 flex
                  items-center justify-center rounded-full bg-amber-500
                  text-neutral-900 hover:bg-amber-600 transition"
                    >
        ...
        <div
          className="hidden md:block md:-bottom-42 absolute bottom-8 left-8 lg:bottom-10
        lg:left-10 animate-bounce "
        >
          <div
            className="bg-neutral-900 text-white px-2.5 py-1.5 rounded-lg
          text-xs lg:text-sm flex items-center shadow-lg "
          >
        ...
        <div
          className="hidden md:block absolute top-16 right-[15%] lg:top-20 lg:rigt-[20%]
